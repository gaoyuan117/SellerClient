...
//	 * @param activity
//	 */
//	public VoicePlayClickListener(ECMessage message, ImageView v, ImageView iv_read_status, BaseAdapter adapter, Activity activity,
//								  String username) {
...
//		voiceAnimation.stop();
//		if (message. == ECMessage.Direct.RECEIVE) {
...
//		}
//
//		if (message.direct == ECMessage.Direction.SEND) {
//			// for sent msg, we will try to play the voice file directly
//			playVoice(voiceBody.getLocalUrl());
//		} else {
//			if (message.status == ECMessage.MessageStatus.SUCCESS) {
