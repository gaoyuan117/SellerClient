...
public class SidebarLable extends View {
	private Paint paint;
	...
	public SidebarLable(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void setHeaderTextAndscroll(MotionEvent event){
		...
		LableDetailAdapter adapter = (LableDetailAdapter) ha.getWrappedAdapter();
