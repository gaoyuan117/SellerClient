...
public class SidebarRemind extends View {
	private Paint paint;
	...
	public SidebarRemind(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void setHeaderTextAndscroll(MotionEvent event){
		...
		RemindFriendsAdapter adapter = (RemindFriendsAdapter) ha.getWrappedAdapter();
