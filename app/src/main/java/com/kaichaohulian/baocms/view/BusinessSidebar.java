...
public class BusinessSidebar extends View {
	private Paint paint;
	...
	public BusinessSidebar(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void setHeaderTextAndscroll(MotionEvent event){
		...
		header.setText(headerString);
		  ...
		  BusinessAdapter adapter = (BusinessAdapter) ha.getWrappedAdapter();
