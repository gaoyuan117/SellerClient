...
import com.kaichaohulian.baocms.ecdemo.common.utils.BitmapUtil;
...
import com.kaichaohulian.baocms.ecdemo.pojo.RichTextBean;
...
import com.kaichaohulian.baocms.ecdemo.ui.group.DemoGroupNotice;
...
public class IMChattingHelper implements OnChatReceiveListener,
    ...
    public static final String INTENT_ACTION_SYNC_MESSAGE = "com.kaichaohulian.baocms_sync_message";
    public static final String INTENT_ACTION_CHAT_USER_STATE = "com.kaichaohulian.baocms_chat_state";
    public static final String INTENT_ACTION_CHAT_EDITTEXT_FOUCU = "com.kaichaohulian.baocms_chat_edit_foucs";
            ...
            ECDevice.getPersonInfo(clientUser.getUserId(), new ECDevice.OnGetPersonInfoListener() {
                ...
                public void onGetPersonInfoComplete(ECError e, PersonInfo p) {
                    if (e.errorCode == SdkErrorCode.REQUEST_SUCCESS && p != null) {
                        ...
                        try {
                            Log.d("TRACE", "IMChattingHelper-----getPersonInfo");
    ...
    private synchronized void postReceiveMessage(ECMessage msg, boolean showNotice) {
        ...
        // 是否状态栏提示
        if (showNotice) {
            LogUtil.e("TRACE", " postReceiveMessage");
...
//        LogUtil.e("TRACE", "sender:" + notice.getSender());
//        if (!TextUtils.isEmpty(sender) && "10089".equals(sender)) {
//            return;
//        }
        ...
        GroupNoticeHelper.insertNoticeMessage(notice,
                new GroupNoticeHelper.OnPushGroupNoticeMessageListener() {
                    ...
                    public void onPushGroupNoticeMessage(DemoGroupNotice system) {
                        ...
                        LogUtil.e("TRACE", " GroupNoticeHelper.insertNoticeMessage" + system.getSender());
                        // 是否状态栏提示
                        showNotification(msg);
                    }
                });
    ...
    public void onReceiveOfflineMessageCompletion() {
        ...
        try {
            if (lastECMessage != null && mHistoryMsgCount > 0 && isFirstSync) {
                LogUtil.e("TRACE", " onReceiveOfflineMessageCompletion");
    ...
    private synchronized void postDowloadMessageResult(ECMessage message) {
        ...
        if (showNotice) {
            LogUtil.e("TRACE", " postDowloadMessageResult");
