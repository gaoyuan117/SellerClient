...
public enum ChattingRowType {
     ...
     * Display text of message received
     */
    DESCRIPTION_IDCARD_RECEIVED("C20323R" , Integer.valueOf(20)),

    /**
     * Display text of message transmitted
     */
    DESCRIPTION_IDCARD_TRANSMIT("C20323T" , Integer.valueOf(21)),

    /**
     * Display text of message received
     */
    DESCRIPTION_REDBAG_RECEIVED("C20324R" , Integer.valueOf(22)),

    /**
     * Display text of message transmitted
     */
    DESCRIPTION_REDBAG_TRANSMIT("C20324T" , Integer.valueOf(23)),

    /**
     * Display text of message received
     */
    DESCRIPTION_ZHUAN_RECEIVED("C20325R" , Integer.valueOf(24)),

    /**
     * Display text of message transmitted
     */
    DESCRIPTION_ZHUAN_TRANSMIT("C20325T" , Integer.valueOf(25)),

    /**
     * Display text of message transfer
     */
    DESCRIPTION_TRANSFER_RECEIVED("C20326R" , Integer.valueOf(26)),

    /**
     * Display text of message transfer
     */
    DESCRIPTION_TRANSFER_TRANSMIT("C20326T" , Integer.valueOf(27));
    ...
    /**
     * Method that returns an instance of {@link com.kaichaohulian.baocms.ecdemo.common.utils.ECPreferenceSettings} from its.
     * unique identifier
     *
