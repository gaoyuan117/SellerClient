...
import com.kaichaohulian.baocms.ecdemo.ui.chatting.RedPacketUtil;
    ...
    protected void updateNewMsgNotification(int type) {
        try {
            if(type == 0) {
                ...
                LogUtil.d(TAG, "com.kaichaohulian.baocms_new_msg_sound " + mSettingSound.isChecked());
                return ;
            }
            if(type == 1) {
                if(mSettingShake == null) {
