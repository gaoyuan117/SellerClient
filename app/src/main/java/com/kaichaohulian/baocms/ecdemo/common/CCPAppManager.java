 ...
 */
package com.kaichaohulian.baocms.ecdemo.common;
...
import com.kaichaohulian.baocms.ecdemo.common.utils.MimeTypesTools;
...
import com.kaichaohulian.baocms.ecdemo.ui.chatting.ImageGalleryActivity;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.ImageGralleryPagerActivity;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.ImageMsgInfoEntry;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.ViewImageInfo;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.view.ChatFooterPanel;
import com.kaichaohulian.baocms.ecdemo.ui.voip.VideoActivity;
import com.kaichaohulian.baocms.ecdemo.ui.voip.VoIPCallActivity;
...
public class CCPAppManager {
     ...
     * 包名
     */
    public static String pkgName = "com.kaichaohulian.baocms";
    /**
     * SharedPreferences 存储名字前缀
     */
    public static final String PREFIX = "com.kaichaohulian.baocms_";
    ...
    public static void sendRemoveMemberBR() {
        ...
        getContext().sendBroadcast(new Intent("com.kaichaohulian.baocms.removemember"));
    }
    ...
    public static ClientUser getClientUser() {
        ...
        Log.e("BUGTRACE", "registerAccount : " + registerAccount);
...
//        }
    ...
    private static String getAutoRegisterAccount() {
        ...
        String registerAutoId = registerAuto.getId();
        String registerAccount = sharedPreferences.getString(registerAutoId, (String) registerAuto.getDefaultValue());
        Log.e("BUGTRACE", "getAutoRegisterAccount : " + registerAccount);
     ...
     * @param clearTop
     */
    public static void startGroupChattingAction(Context context, String contactid, String username, int id, boolean clearTop) {
        Intent intent = new Intent(context, ChattingActivity.class);
        if (clearTop) {
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        }
        ...
        Bundle.putInt("id", id);
        Bundle.putString("chatGroupId", contactid);
...
//            mChecks.add(ECVoIPSetupManager.Codec.Codec_OPUS48.ordinal());
    ...
    public static void startShowBaiDuMapAction(ChattingActivity mContext2, ECMessage iMessage) {
        if (iMessage == null || mContext2 == null) {
            return;
        }
//        Intent intent = new Intent(mContext2, ShowBaiDuMapActivity.class);
        Intent intent = new Intent(mContext2, BaiduMapActivity.class);
        ...
        intent.putExtra("address", body.getTitle());
        mContext2.startActivityForResult(intent, 4);
