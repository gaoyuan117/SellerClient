...
import com.kaichaohulian.baocms.ecdemo.ui.chatting.holder.RedPacketAckViewHolder;
...
//                }
                ...
                Glide.with(baseHolder.getBaseView().getContext()).load(avaterPath)
                        .error(R.mipmap.default_useravatar).into(baseHolder.getChattingAvatar());
