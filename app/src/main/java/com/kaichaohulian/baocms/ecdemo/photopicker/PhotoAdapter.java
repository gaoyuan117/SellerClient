 ...
 */package com.kaichaohulian.baocms.ecdemo.photopicker;
...
import com.kaichaohulian.baocms.ecdemo.photopicker.model.Photo;
import com.kaichaohulian.baocms.ecdemo.photopicker.utils.PhotoUtils;
import com.kaichaohulian.baocms.ecdemo.photopicker.widgets.SquareImageView;
...
public class PhotoAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(getItemViewType(position) == TYPE_CAMERA) {
            ...
            holder.photoImageView.setImageResource(R.mipmap.picker_ic_photo_loading);
