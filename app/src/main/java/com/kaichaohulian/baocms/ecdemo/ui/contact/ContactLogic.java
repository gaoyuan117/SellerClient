 ...
 */package com.kaichaohulian.baocms.ecdemo.ui.contact;
...
import com.kaichaohulian.baocms.ecdemo.common.utils.DialNumberMap;
import com.kaichaohulian.baocms.ecdemo.common.utils.ECPropertiesUtil;
...
import com.kaichaohulian.baocms.ecdemo.core.ECArrayLists;
import com.kaichaohulian.baocms.ecdemo.core.Phone;
import com.kaichaohulian.baocms.ecdemo.core.comparator.PyComparator;
...
//							char c = name.charAt(i);
    ...
    public static Bitmap getChatroomPhoto(final String groupid) {
        ...
        if(groupid.toUpperCase().startsWith("G")) {
            return BitmapFactory.decodeResource(CCPAppManager.getContext().getResources() , R.mipmap.group_head);
        }
        return mDefaultBitmap;
    }
