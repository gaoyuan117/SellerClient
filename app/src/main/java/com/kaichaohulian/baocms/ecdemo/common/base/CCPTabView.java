 ...
 */package com.kaichaohulian.baocms.ecdemo.common.base;
...
import com.kaichaohulian.baocms.ecdemo.common.CCPAccessibilityManager;
...
public class CCPTabView extends ViewGroup {
    ...
    private void init() {
        ...
        descriptionImage.setImageResource(R.mipmap.unread_dot);
        ...
        tips.setBackgroundResource(R.mipmap.to_read_tips_onbackbtn);
        tips.setGravity(Gravity.CENTER);
        tips.setVisibility(View.INVISIBLE);

        addView(mTabUnreadTips = tips);

        setBackgroundResource(R.mipmap.tab_item_bg);
