...
import com.kaichaohulian.baocms.ecdemo.ui.ActivityTransition;
...
public class SettingPersionInfoActivity extends ECSuperActivity implements View.OnClickListener{
    ...
    private void saveClientUser() {
        try {
            Log.d("BUGTRACE","SettingPersionInfoAty-----saveClientUser : "+clientUser.toString());
                ...
                if (SdkErrorCode.REQUEST_SUCCESS == e.errorCode) {
                    try {
                        ...
                        if (clientUser != null) {
                            ...
                            Log.d("BUGTRACE","SettingPersionInfoAty-----handlePersionInfo : "+clientUser.toString());
                            ECPreferences.savePreference(ECPreferenceSettings.SETTINGS_REGIST_AUTO, clientUser.toString(), true);
