package com.kaichaohulian.baocms.ecdemo.core;
...
public class ContactsCache {
    // 初始化联系人
    public static final String ACTION_ACCOUT_INIT_CONTACTS = "com.kaichaohulian.baocms.intent.ACCOUT_INIT_CONTACTS";
    ...
    public synchronized void load() {
        try {
            //TODO 2017-03-11解决AsyncTask多次执行问题
//            if (asyncTask == null) {
