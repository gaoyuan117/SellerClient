...
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.BaseChattingRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.CallRxRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.CallTxRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.ChattingRowType;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.ChattingSystemRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.DescriptionRxRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.DescriptionTxRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.FileRxRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.FileTxRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.IChattingRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.IDCardRxRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.IDCardTxRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.ImageRxRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.ImageTxRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.LocationRxRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.LocationTxRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.RedPacketAckRxRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.RedPacketAckTxRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.RedPacketRxRow;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.RedPacketTxRow;
...
public class ChattingListAdapter2 extends CCPListAdapter<ECMessage> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position != 0) {
            ...
            if (mShowTimePosition.contains(item.getMsgId()) || (item.getMsgTime() - previousItem.getMsgTime() >= 180000L)) {
                showTimer = true;
            }
        }
...
//                    }
//                }else if(isRead>1){
//                    if(textView!=null&&isPeerChat(mUsername)){
//                        textView.setText(isRead+"人已读");
//
//                    }else  textView.setText("已读");
//                }else if(isRead==0){
//                    if(textView!=null){
//                        textView.setText("未读");
//                    }
