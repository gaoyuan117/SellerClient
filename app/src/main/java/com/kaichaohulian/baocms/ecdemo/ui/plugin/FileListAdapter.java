 ...
 */
package com.kaichaohulian.baocms.ecdemo.ui.plugin;
...
import com.kaichaohulian.baocms.ecdemo.common.utils.CnToCharUntil;
...
public class FileListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(file == mParentFile) {
			mViewHolder.mFileIcon.setImageResource(R.mipmap.im_attach_back);
		} else {
			if(file.isDirectory()) {
				mViewHolder.mFileIcon.setImageResource(R.mipmap.file_attach_folder);
			} else {
