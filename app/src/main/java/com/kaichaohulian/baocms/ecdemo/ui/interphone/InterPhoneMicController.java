...
public class InterPhoneMicController extends FrameLayout implements View.OnTouchListener {
    ...
    public void setControlMicType(MicType type) {
        ...
        if(type == MicType.CONTROL) {
            ...
            mChronometer.start();
            mChronometer.setVisibility(View.VISIBLE);
            mInterSpeak.setBackgroundResource(R.mipmap.voice_intephone_connect) ;
            return ;
        }
        ...
        if(isDownEvent) {
            mInterSpeak.setBackgroundResource(R.mipmap.voice_intephone_failed) ;
        } else {
            mInterSpeak.setBackgroundResource(R.mipmap.voice_intephone_normal) ;
        }
    }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                mInterSpeak.setBackgroundResource(R.mipmap.voice_intephone_pressed);
                if (mHandler != null ) {
