...
import com.kaichaohulian.baocms.ecdemo.photoview.PhotoView;
import com.kaichaohulian.baocms.ecdemo.photoview.PhotoViewAttacher;
...
public class ImageGalleryFragment extends CCPFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (IMessageSqlManager.isFireMsg(mEntry.getMsgLocalId()) && ("1".equals(IMessageSqlManager.getMsgReadStatus(mEntry.getMsgLocalId())))) {
            mImageView.setImageResource(R.mipmap.fire_msg_big);
            return;
        }
