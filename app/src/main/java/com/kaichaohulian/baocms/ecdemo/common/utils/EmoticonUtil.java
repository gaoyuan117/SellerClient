...
import com.kaichaohulian.baocms.ecdemo.ui.chatting.base.EmojiconHandler;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.base.emoji.Emojicon;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.base.emoji.People;
import com.kaichaohulian.baocms.ecdemo.ui.chatting.model.CCPEmoji;
	...
	public static void initEmoji() {
		...
		for(Emojicon emojicon:data) {
			if(emojicon.getEmoji() != null) {
				...
				if(unicode > 0xff) {
					emoji.setId(EmojiconHandler.getEmojiResource(MyApplication.getInstance().getApplicationContext(), unicode));
					emojis.add(emoji);
				}
			}
		}
