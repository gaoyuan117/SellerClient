...
import com.kaichaohulian.baocms.ecdemo.core.comparator.ServerConfigBean;
...
public class ServerConfigSqlManager  {
    ...
    private ServerConfigSqlManager(){
         sqliteDBHelper=new ServerConfigDB(MyApplication.getInstance(),null,null, CCPAppManager.getVersionCode());
        if(sqliteDB==null){
