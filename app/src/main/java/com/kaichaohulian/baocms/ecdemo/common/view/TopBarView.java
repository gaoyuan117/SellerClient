...
public class TopBarView extends LinearLayout {
    ...
    private void initView() {
        ...
        setBackgroundDrawable(new ColorDrawable(mContext.getResources().getColor(R.color.common_top_bar_blue)));
     ...
     * @param l
     */
    public void setTopBarToStatus(int type, int leftResid, int rightResid, String title, OnClickListener l) {
