...
import com.kaichaohulian.baocms.ecdemo.common.AudioManagerTools;
import com.kaichaohulian.baocms.ecdemo.common.base.CCPLayoutListenerView;
...
import com.kaichaohulian.baocms.ecdemo.common.view.TopBarView;
import com.kaichaohulian.baocms.ecdemo.common.view.VerticalImageSpan;
...
public abstract class CCPActivityBase {
    ...
    protected SpannableString buildActionTitle() {
        ...
        if(isMute) {
            if(mMuteIcon == null) {
                mMuteIcon = getTitleIconTips(dimensionPixelSize, R.mipmap.chat_mute_notify_title_icon);
            }
