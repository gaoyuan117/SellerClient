...
public class RedBagTxRow extends BaseChattingRow {

    public RedBagTxRow(int type) {
        super(type);
    ...
    public View buildChatView(LayoutInflater inflater, View convertView) {
        if (convertView == null) {
            convertView = new ChattingItemContainer(inflater, R.layout.chatting_item_idcard_to);
    ...
    public int getChatViewType() {
        ...
        return ChattingRowType.DESCRIPTION_IDCARD_TRANSMIT.ordinal();
    }
