...
public class CCPAnimImageView extends TextView {
	...
	public final void startVoiceAnimation() {
		...
		case TYPE_VOICE_DOWNLOADING:
			...
			if(isFrom) {
				setBackgroundDrawable(mActivity.getResources().getDrawable(R.mipmap.chatfrom_bg_voice_downloading));
			} else {
				setBackgroundDrawable(mActivity.getResources().getDrawable(R.mipmap.chatto_bg_voice_downloading));
			}
