...
public class ActivityUtil {
    ...
    public static void nextWithoutFinish(Activity curActivity, Class<?> nextActivity, Bundle extras) {
        next(curActivity, nextActivity, extras, -1, -1, R.anim.in_from_right, R.anim.out_to_left, true);
    }
