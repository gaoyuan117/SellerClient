 ...
 */
public class RemindFriendsAdapter extends ArrayAdapter<ContactFriendsEntity> implements SectionIndexer {
    ...
    public RemindFriendsAdapter(Context context, int resource, List<ContactFriendsEntity> objects) {
        super(context, resource, objects);
        this.res = resource;
        this.userList = objects;
        copyUserList = new ArrayList<ContactFriendsEntity>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        selected = getIsSelected().get(position);
        if(selected){
            isSelectImg.setImageResource(R.mipmap.ssdk_oks_classic_check_checked);
        }else{
            isSelectImg.setImageResource(R.mipmap.ssdk_oks_classic_check_default);
        }
        ...
        if (!StringUtils.isEmpty(useravatar)) {
            switch (res){
                case R.layout.item_remind_friends_list:
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        RemindFriendsAdapter.isSelected = isSelected;
    }
}
