 ...
 */
public class LableDetailAdapter extends ArrayAdapter<LableDetailEntity> implements SectionIndexer {

    List<String> list;
    List<LableDetailEntity> userList;
    List<LableDetailEntity> copyUserList;
    ...
    public LableDetailAdapter(Context context, int resource, List<LableDetailEntity> objects) {
        super(context, resource, objects);
        this.res = resource;
        this.userList = objects;
        copyUserList = new ArrayList<LableDetailEntity>();
        copyUserList.addAll(objects);
        layoutInflater = LayoutInflater.from(context);

        DBLog.i("提醒好友通信录",userList.toString());
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView isSelectImg = (ImageView) convertView.findViewById(R.id.is_select_img_remind);
        ...
        LableDetailEntity user = getItem(position);
        if (user == null)
    ...
    @Override
    public LableDetailEntity getItem(int position) {
    ...
    private class MyFilter extends Filter {
        List<LableDetailEntity> mList = null;

        public MyFilter(List<LableDetailEntity> myList) {
            super();
            this.mList = myList;
        }
        ...
        protected synchronized FilterResults performFiltering(
            ...
            if (mList == null) {
                mList = new ArrayList<LableDetailEntity>();
            }
            if (prefix == null || prefix.length() == 0) {
                ...
                final ArrayList<LableDetailEntity> newValues = new ArrayList<LableDetailEntity>();
                for (int i = 0; i < count; i++) {
                    final LableDetailEntity user = mList.get(i);
        ...
        protected synchronized void publishResults(CharSequence constraint,
            ...
            userList.clear();
            userList.addAll((List<LableDetailEntity>) results.values);
            if (results.count > 0) {
