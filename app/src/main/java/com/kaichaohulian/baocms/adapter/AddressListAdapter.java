 ...
 */
public class AddressListAdapter extends ArrayAdapter<ContactFriendsEntity> implements SectionIndexer {
    ...
    public AddressListAdapter(Context context, int resource, List<ContactFriendsEntity> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (!StringUtils.isEmpty(useravatar)) {
            switch (res) {
                case R.layout.item_tranfer_address_list:
