...
public class NearByPeopleListAdapter extends BaseAdapter {
    Context context;
    LayoutInflater inflater;
    List<NearByPeopleListEntity> data ;
...
//    int face[] = RandomIcon.face;
    public NearByPeopleListAdapter(Context context, List<NearByPeopleListEntity> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.txtSign.setText(data.get(position).getMySign());
        viewHolder.txtDistance.setText(data.get(position).getDistance());
        Glide.with(context)
                .load(data.get(position).getHeadIconURL())
