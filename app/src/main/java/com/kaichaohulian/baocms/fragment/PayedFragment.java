...
import com.kaichaohulian.baocms.adapter.PayedAdapter;
...
public class PayedFragment extends BaseFragment {
    ...
    ListView listView;
    public PayedFragment(MyApplication myApplication, Activity activity, Context context) {
        super(myApplication, activity, context);
    }

    @Override
    public void setContent() {
        mView = LayoutInflater.from(getContext()).inflate(R.layout.fragment_payed,null);
    }
    ...
    public void initView() {
        listView = getId(R.id.payed_list);
//        adapter = new PayedAdapter(getContext(),data);
