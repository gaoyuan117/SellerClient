...
import com.kaichaohulian.baocms.circledemo.spannable.CircleMovementMethod;
import com.kaichaohulian.baocms.circledemo.spannable.SpannableClickable;
...
public class FavortListAdapter {
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(MyApplication.getInstance().getApplicationContext(), R.mipmap.icon_like, DynamicDrawableSpan.ALIGN_BASELINE),
