...
public class BlackListSelectActivity extends BaseActivity {
    ...
    public void initData() {
        contactList = new ArrayList<RecentlyContact>();
    }
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    if (response.getInt("code") == 0) {
                        ...
                        Intent intent = new Intent(BlackListSelectActivity.this, WithDrawToFriendActivity.class);
