...
import com.kaichaohulian.baocms.BuildConfig;
import com.kaichaohulian.baocms.R;
import com.kaichaohulian.baocms.entity.VideoEntity;
import com.kaichaohulian.baocms.util.ImageCache;
import com.kaichaohulian.baocms.util.ImageResizer;
import com.kaichaohulian.baocms.util.Utils;
import com.kaichaohulian.baocms.view.RecyclingImageView;
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			...
			if(position==0)
			{
				...
				holder.tvDur.setText(entty.duration+"");
				holder.tvSize.setText(entty.size+"");
