...
public class ShopNameEditActivity extends BaseActivity {
    ...
    public void setContent() {
        setContentView(R.layout.aty_shop_name);
    }
    ...
    public void updateShop() {
        ...
        params.put("shopName", editTextName.getText().toString().trim());
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    if (response.getInt("code") == 0) {
                        ...
                        intent.putExtra("shopname", editTextName.getText().toString().trim());
