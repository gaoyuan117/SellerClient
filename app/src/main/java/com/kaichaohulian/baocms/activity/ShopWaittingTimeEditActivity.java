 ...
 * 我的姓名 编辑页面
 */
public class ShopWaittingTimeEditActivity extends BaseActivity {
    ...
    public void setContent() {
        setContentView(R.layout.aty_shop_waitingtime);
    }
    ...
    public void updateShop() {
        ...
        params.put("deliveryTime", editTextName.getText().toString().trim());
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    if (response.getInt("code") == 0) {
                        ...
                        intent.putExtra("deliveryTime", editTextName.getText().toString().trim());
